...
%The key differences of those different paradigms are highlighted in figure\cref{fig:fogVall}.
...
\begin{description}
	\item[Lack of \acrfullpl{SLA}] that would cover all the challenges posed by the evolution from Cloud to Fog, including \cite{chiang_fog_2016, bonomi_fog_2012}:
		\begin{enumerate*}[(1)]
